...
export default class LittleboynyLaser extends GenericDevice {
  private on: boolean = false;
  public color: number = 0;
  public spinColor: boolean = false;

  public constructor(dmx: DMXSender, address: number) {
    super(dmx, address, 11);
    this.setChannel(0, 255);
    this.setChannel(1, 255);
    this.setChannel(2, 255);
    this.setChannel(3, 255);
    this.setChannel(4, 255);
    this.setChannel(10, 255);
  }

//   public setOn(on: boolean) {
//     this.on = on;
//     this.setChannel(0, this.on ? );
//   }
